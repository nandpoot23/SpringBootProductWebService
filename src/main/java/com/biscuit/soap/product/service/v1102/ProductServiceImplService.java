 ...
 * 
 */
@WebServiceClient(name = "ProductServiceImplService", targetNamespace = "http://service.product.soap.biscuit.com/", wsdlLocation = "http://localhost:8080/ProductService/services/ProductService/11.02?wsdl")
public class ProductServiceImplService extends Service {
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/ProductService/services/ProductService/11.02?wsdl");
