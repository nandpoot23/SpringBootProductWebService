 ...
 * 
 */
@WebServiceClient(name = "ProductServiceImplService", targetNamespace = "http://service.product.soap.biscuit.com/", wsdlLocation = "http://localhost:8080/ProductService/services/ProductService/10.01?wsdl")
public class ProductServiceImplService extends Service {
    ...
    private final static QName PRODUCTSERVICEIMPLSERVICE_QNAME = new QName("http://service.product.soap.biscuit.com/",
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/ProductService/services/ProductService/10.01?wsdl");
    ...
    public ProductService getProductServiceImplPort() {
        return super.getPort(new QName("http://service.product.soap.biscuit.com/", "ProductServiceImplPort"),
